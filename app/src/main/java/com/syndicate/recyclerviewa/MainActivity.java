package com.syndicate.recyclerviewa;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nm = new NegaraModel();
        nm.setNama("Slovenia");
        nm.setDeskripsi("Belum ada deskripi untuk negara ini. Silakan ditambahkan bagi yang memiliki informasi");
        nm.setUrl("https://icons.iconarchive.com/icons/custom-icon-design/all-country-flag/48/Slovenia-Flag-icon.png");
        negaraModelList.add(nm);

        nm = new NegaraModel();
        nm.setNama("Belgium");
        nm.setDeskripsi("Negara ini bernama Beliga dalam bahasa Indonesia. Negara ini terdapat di Eropa");
